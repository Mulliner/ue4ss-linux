...
namespace RC::Unreal
{
    ...
    bool UObject425::UObject_HasAnyInternalFlags(void* p_this, const EInternalObjectFlags FlagsToCheck)
    {
        return FUObjectArray::IndexToObject(UObject_get_internal_index(p_this))->HasAnyFlags(FlagsToCheck);
    }
}
