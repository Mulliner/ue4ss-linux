...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority__Ref_C_FVector__Ref_C_FVector__Ptr_APlayerController__Ptr_UActorChannel__float__bool"), 0x310);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority__Ref_C_FVector__Ref_C_FVector__Ptr_AActor__Ptr_AActor__Ptr_UActorChannel__float__bool"), 0x318);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy__Ref_C_FVector__Ref_C_FVector__Ptr_APlayerController__Ptr_AActor__Ptr_UActorChannel__float__bool"), 0x320);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_C__Ptr_C_APlayerController__Ptr_C_AActor__Ref_C_FVector"), 0x3B0);
}
