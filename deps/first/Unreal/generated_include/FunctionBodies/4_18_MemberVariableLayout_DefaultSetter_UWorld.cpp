...
{
    UWorld::MemberOffsets.emplace(STR("ActiveLevelCollectionIndex"), 0x130);
}
...
{
    UWorld::MemberOffsets.emplace(STR("URL"), 0x6D0);
}
...
{
    UWorld::MemberOffsets.emplace(STR("bAggressiveLOD"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsDefaultLevel"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bRequestedBlockOnAsyncLoading"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bActorsInitialized"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bBegunPlay"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bMatchStarted"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bPlayersOnly"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bPlayersOnlyPending"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bStartup"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsTearingDown"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bKismetScriptError"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bDebugPauseExecution"), 0x990);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsCameraMoveableWhenPaused"), 0x990);
    UWorld::BitfieldInfos.emplace(STR("bIsCameraMoveableWhenPaused"), BitfieldInfo{13, 1, 28});
}

if (auto it = UWorld::MemberOffsets.find(STR("bAllowAudioPlayback")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("bAllowAudioPlayback"), 0x990);
    UWorld::BitfieldInfos.emplace(STR("bAllowAudioPlayback"), BitfieldInfo{14, 1, 4});
}

if (auto it = UWorld::MemberOffsets.find(STR("bDebugFrameStepExecution")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("bDebugFrameStepExecution"), 0x990);
    UWorld::BitfieldInfos.emplace(STR("bDebugFrameStepExecution"), BitfieldInfo{15, 1, 4});
}

if (auto it = UWorld::MemberOffsets.find(STR("bAreConstraintsDirty")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("bAreConstraintsDirty"), 0x990);
    UWorld::BitfieldInfos.emplace(STR("bAreConstraintsDirty"), BitfieldInfo{16, 1, 4});
}

if (auto it = UWorld::MemberOffsets.find(STR("AsyncPreRegisterLevelStreamingTasks")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("AsyncPreRegisterLevelStreamingTasks"), 0x994);
}

if (auto it = UWorld::MemberOffsets.find(STR("UEP_TotalSize")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x9A0);
}
