...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UPendingNetGame__Ref_FString__bool"), 0x398);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UWorld__Ref_FString__bool"), 0x3A0);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ptr_UNetDriver"), 0x418);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("CancelPending__Ref_FWorldContext")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ref_FWorldContext"), 0x420);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ptr_UWorld__Ptr_UPendingNetGame"), 0x428);
}
