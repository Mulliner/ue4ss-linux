...
{
    UWorld::MemberOffsets.emplace(STR("ViewLocationsRenderedLastFrame"), 0xC8);
}

if (auto it = UWorld::MemberOffsets.find(STR("bWorldWasLoadedThisTick")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("bWorldWasLoadedThisTick"), 0xD8);
...
{
    UWorld::MemberOffsets.emplace(STR("bTriggerPostLoadMap"), 0xD8);
...
{
    UWorld::MemberOffsets.emplace(STR("bAggressiveLOD"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsDefaultLevel"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bRequestedBlockOnAsyncLoading"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bActorsInitialized"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bBegunPlay"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bMatchStarted"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bPlayersOnly"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bPlayersOnlyPending"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bStartup"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsTearingDown"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bKismetScriptError"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bDebugPauseExecution"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsCameraMoveableWhenPaused"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bAllowAudioPlayback"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bDebugFrameStepExecution"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("bAreConstraintsDirty"), 0x980);
...
{
    UWorld::MemberOffsets.emplace(STR("AsyncPreRegisterLevelStreamingTasks"), 0x984);
}

if (auto it = UWorld::MemberOffsets.find(STR("UEP_TotalSize")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x990);
}
