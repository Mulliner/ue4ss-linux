...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin__Ref_C_FString__Ref_C_FString__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_FString"), 0x700);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin__Ref_C_FString__Ref_C_FString__Ref_C_FUniqueNetIdRepl__Ref_FString"), 0x708);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login__Ptr_UPlayer__ENetRole__Ref_C_FString__Ref_C_FString__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_FString"), 0x710);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer__Ptr_APlayerController__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_C_FString__Ref_C_FString"), 0x788);
}
