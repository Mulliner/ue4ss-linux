...
if (auto it = UGameViewportClient::MemberOffsets.find(STR("bIsPlayInEditorViewport")); it == UGameViewportClient::MemberOffsets.end())
{
    ...
    UGameViewportClient::BitfieldInfos.emplace(STR("bIsPlayInEditorViewport"), BitfieldInfo{0, 1, 4});
}
...
if (auto it = UGameViewportClient::MemberOffsets.find(STR("bDisableWorldRendering")); it == UGameViewportClient::MemberOffsets.end())
{
    ...
    UGameViewportClient::BitfieldInfos.emplace(STR("bDisableWorldRendering"), BitfieldInfo{1, 1, 4});
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("CurrentBufferVisualizationMode"), 0x140);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("CurrentNaniteVisualizationMode"), 0x148);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("CurrentLumenVisualizationMode"), 0x150);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("CurrentSubstrateVisualizationMode"), 0x158);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("CurrentGroomVisualizationMode"), 0x160);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("bDisableSplitScreenOverride"), 0x3B8);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("bIgnoreInput")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("bIgnoreInput"), 0x3B9);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("MouseCaptureMode")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("MouseCaptureMode"), 0x3BA);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("bHideCursorDuringCapture")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("bHideCursorDuringCapture"), 0x3BB);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("MouseLockMode")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("MouseLockMode"), 0x3BC);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("bIsMouseOverClient")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("bIsMouseOverClient"), 0x3BD);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("UEP_TotalSize")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x3C0);
}
