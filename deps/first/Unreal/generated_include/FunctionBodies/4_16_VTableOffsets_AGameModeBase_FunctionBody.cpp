...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitializeHUDForPlayer_Implementation"), 0x5E8);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitStartSpot_Implementation")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitStartSpot_Implementation"), 0x5F0);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnDefaultPawnAtTransform_Implementation"), 0x5F8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("HandleStartingNewPlayer_Implementation"), 0x630);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("ShouldReset_Implementation")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ShouldReset_Implementation"), 0x638);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin__Ref_C_FString__Ref_C_FString__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_FString"), 0x6F0);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin__Ref_C_FString__Ref_C_FString__Ref_C_FUniqueNetIdRepl__Ref_FString"), 0x6F8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login__Ptr_UPlayer__ENetRole__Ref_C_FString__Ref_C_FString__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_FString"), 0x700);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer__Ptr_APlayerController__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_C_FString__Ref_C_FString"), 0x778);
}
