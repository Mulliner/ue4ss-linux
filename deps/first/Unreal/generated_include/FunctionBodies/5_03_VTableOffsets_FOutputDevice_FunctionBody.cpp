...
if (auto it = FOutputDevice::VTableLayoutMap.find(STR("SerializeRecord")); it == FOutputDevice::VTableLayoutMap.end())
{
    FOutputDevice::VTableLayoutMap.emplace(STR("SerializeRecord"), 0x18);
}
