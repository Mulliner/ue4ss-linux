...
{
    UEngine::VTableLayoutMap.emplace(STR("ResetPIEAudioSetting"), 0x328);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("InitializeEyeTrackingDevice"), 0x370);
}
