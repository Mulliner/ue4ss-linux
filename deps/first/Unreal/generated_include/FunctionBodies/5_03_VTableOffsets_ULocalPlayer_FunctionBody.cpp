...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("GetSlateUser_C"), 0x2D0);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("GetSlateUser")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("GetSlateUser"), 0x2D8);
}
...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded__Ptr_UGameViewportClient__FPlatformUserId"), 0x2F0);
}
...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded__Ptr_UGameViewportClient__int32"), 0x2F8);
}
