...
if (auto it = AActor::MemberOffsets.find(STR("bAllowTickBeforeBeginPlay")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bAllowTickBeforeBeginPlay"), BitfieldInfo{3, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bAutoDestroyWhenFinished")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bAutoDestroyWhenFinished"), BitfieldInfo{4, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bBlockInput")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bBlockInput"), BitfieldInfo{5, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bCanBeDamaged")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bCanBeDamaged"), 0x81);
    AActor::BitfieldInfos.emplace(STR("bCanBeDamaged"), BitfieldInfo{6, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bCollideWhenPlacing")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bCollideWhenPlacing"), 0x81);
    AActor::BitfieldInfos.emplace(STR("bCollideWhenPlacing"), BitfieldInfo{7, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bFindCameraComponentWhenViewTarget")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bFindCameraComponentWhenViewTarget"), BitfieldInfo{0, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bGenerateOverlapEventsDuringLevelStreaming")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bGenerateOverlapEventsDuringLevelStreaming"), BitfieldInfo{1, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bIgnoresOriginShifting")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bIgnoresOriginShifting"), BitfieldInfo{2, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bEnableAutoLODGeneration")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bEnableAutoLODGeneration"), BitfieldInfo{3, 1, 1});
}
...
{
    AActor::MemberOffsets.emplace(STR("bReplicates"), 0x82);
    AActor::BitfieldInfos.emplace(STR("bReplicates"), BitfieldInfo{5, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bCanBeInCluster")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bCanBeInCluster"), 0x82);
    AActor::BitfieldInfos.emplace(STR("bCanBeInCluster"), BitfieldInfo{6, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bAllowReceiveTickEventOnDedicatedServer")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bAllowReceiveTickEventOnDedicatedServer"), 0x82);
    AActor::BitfieldInfos.emplace(STR("bAllowReceiveTickEventOnDedicatedServer"), BitfieldInfo{7, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bTickFunctionsRegistered")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bTickFunctionsRegistered"), BitfieldInfo{2, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bHasDeferredComponentRegistration")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bHasDeferredComponentRegistration"), BitfieldInfo{3, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bRunningUserConstructionScript")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bRunningUserConstructionScript"), 0x83);
...
{
    AActor::MemberOffsets.emplace(STR("bActorEnableCollision"), 0x83);
    AActor::BitfieldInfos.emplace(STR("bActorEnableCollision"), BitfieldInfo{5, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bActorIsBeingDestroyed")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bActorIsBeingDestroyed"), 0x83);
    AActor::BitfieldInfos.emplace(STR("bActorIsBeingDestroyed"), BitfieldInfo{6, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("ActorHasBegunPlay")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("ActorHasBegunPlay"), BitfieldInfo{0, 2, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bNetCheckedInitialPhysicsState")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bNetCheckedInitialPhysicsState"), BitfieldInfo{0, 1, 1});
}
