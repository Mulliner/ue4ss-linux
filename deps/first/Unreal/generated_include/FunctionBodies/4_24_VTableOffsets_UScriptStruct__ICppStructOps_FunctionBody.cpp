...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Serialize__FStructuredArchiveSlot__Ptr_void"), 0x40);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("GetStructTypeHash"), 0x118);
}
