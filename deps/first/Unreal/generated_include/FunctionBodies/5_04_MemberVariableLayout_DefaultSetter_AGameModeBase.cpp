...
{
    AGameModeBase::MemberOffsets.emplace(STR("bUseSeamlessTravel"), 0x310);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("bStartPlayersAsSpectators"), 0x310);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("bPauseable"), 0x310);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("GameNetDriverReplicationSystem"), 0x314);
}

if (auto it = AGameModeBase::MemberOffsets.find(STR("UEP_TotalSize")); it == AGameModeBase::MemberOffsets.end())
{
    AGameModeBase::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x328);
}
