...
{
    UEngine::VTableLayoutMap.emplace(STR("GetTimeBetweenGarbageCollectionPasses_C__bool"), 0x3A0);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("GetIncrementalGCTimePerFrame"), 0x3D0);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UPendingNetGame__Ref_FString__bool"), 0x490);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UNetConnection__Ref_FString__bool"), 0x498);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ptr_UNetDriver"), 0x508);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("CancelPending__Ref_FWorldContext")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ref_FWorldContext"), 0x510);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ptr_UWorld__Ptr_UPendingNetGame"), 0x518);
}
