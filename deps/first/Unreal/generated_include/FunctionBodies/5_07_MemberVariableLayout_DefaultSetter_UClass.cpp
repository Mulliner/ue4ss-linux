...
if (auto it = UClass::MemberOffsets.find(STR("bNeedsDynamicSubobjectInstancing")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("bNeedsDynamicSubobjectInstancing"), 0x128);
}
...
if (auto it = UClass::MemberOffsets.find(STR("FuncMapLock")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("FuncMapLock"), 0x180);
}

if (auto it = UClass::MemberOffsets.find(STR("AllFunctionsCache")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("AllFunctionsCache"), 0x188);
}

if (auto it = UClass::MemberOffsets.find(STR("AllFunctionsCacheLock")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("AllFunctionsCacheLock"), 0x1D8);
}

if (auto it = UClass::MemberOffsets.find(STR("Interfaces")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("Interfaces"), 0x1E0);
}

if (auto it = UClass::MemberOffsets.find(STR("ReferenceSchema")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("ReferenceSchema"), 0x1F0);
}
