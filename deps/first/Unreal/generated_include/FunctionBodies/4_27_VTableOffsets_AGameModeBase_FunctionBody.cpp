...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitializeHUDForPlayer_Implementation"), 0x638);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitStartSpot_Implementation")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitStartSpot_Implementation"), 0x640);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnDefaultPawnAtTransform_Implementation"), 0x648);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("HandleStartingNewPlayer_Implementation"), 0x680);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("ShouldReset_Implementation")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ShouldReset_Implementation"), 0x688);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController__ENetRole__Ref_C_FVector__Ref_C_FRotator"), 0x770);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel__Ref_FString__bool__bool"), 0x800);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel__Ref_FString__FGuid__bool__bool"), 0x808);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("InitSeamlessTravelPlayer")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitSeamlessTravelPlayer"), 0x810);
}

if (auto it = AGameModeBase::VTableLayoutMap.find(STR("SpawnPlayerControllerCommon")); it == AGameModeBase::VTableLayoutMap.end())
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerControllerCommon"), 0x818);
}
