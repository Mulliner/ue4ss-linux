...
{
    UObject::VTableLayoutMap.emplace(STR("GetAssetRegistryTags_C__FAssetRegistryTagsContext"), 0x1C0);
}
...
{
    UObject::VTableLayoutMap.emplace(STR("RegisterReplicationFragments"), 0x200);
}
