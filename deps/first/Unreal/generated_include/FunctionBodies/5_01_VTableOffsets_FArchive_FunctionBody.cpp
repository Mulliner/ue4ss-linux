...
{
    FArchive::VTableLayoutMap.emplace(STR("AttachBulkData__Ptr_UObject__Ptr_FBulkData"), 0x198);
}
...
{
    FArchive::VTableLayoutMap.emplace(STR("DetachBulkData__Ptr_FBulkData__bool"), 0x1A8);
}
