...
{
    FFieldClass::MemberOffsets.emplace(STR("ClassFlags"), 0x8);
}
...
if (auto it = FFieldClass::MemberOffsets.find(STR("UniqueNameIndexCounter")); it == FFieldClass::MemberOffsets.end())
{
    FFieldClass::MemberOffsets.emplace(STR("UniqueNameIndexCounter"), 0x38);
}
