...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController__ENetRole__Ref_C_UE_Math_TVector_double___Ref_C_UE_Math_TRotator_double_"), 0x830);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController__ENetRole__Ref_C_FString"), 0x838);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel__Ref_FString__FGuid__bool__bool"), 0x8D0);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("ProcessClientTravel__Ref_FString__bool__bool"), 0x8D8);
}
