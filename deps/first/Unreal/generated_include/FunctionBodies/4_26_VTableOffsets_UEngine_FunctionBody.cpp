...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UPendingNetGame__Ref_FString__bool"), 0x400);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UNetConnection__Ref_FString__bool"), 0x408);
}
