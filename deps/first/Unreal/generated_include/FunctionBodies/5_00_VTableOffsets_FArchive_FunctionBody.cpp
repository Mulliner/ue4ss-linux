...
{
    FArchive::VTableLayoutMap.emplace(STR("AttachBulkData__Ptr_UE_Serialization_FEditorBulkData"), 0x190);
}

if (auto it = FArchive::VTableLayoutMap.find(STR("AttachBulkData__Ptr_UObject__Ptr_FUntypedBulkData")); it == FArchive::VTableLayoutMap.end())
{
    FArchive::VTableLayoutMap.emplace(STR("AttachBulkData__Ptr_UObject__Ptr_FUntypedBulkData"), 0x198);
}
