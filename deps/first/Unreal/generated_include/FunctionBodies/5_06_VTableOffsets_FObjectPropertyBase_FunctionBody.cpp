...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetCPPTypeCustom"), 0x1D0);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("LoadObjectPropertyValue"), 0x1D8);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("SetObjectPropertyValueUnchecked"), 0x1E0);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("SetObjectPtrPropertyValueUnchecked"), 0x1E8);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("SetObjectPropertyValueUnchecked_InContainer"), 0x1F0);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("SetObjectPtrPropertyValueUnchecked_InContainer"), 0x1F8);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPropertyValue"), 0x200);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPtrPropertyValue"), 0x208);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPropertyValue_InContainer"), 0x210);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("GetObjectPtrPropertyValue_InContainer"), 0x218);
}

if (auto it = FObjectPropertyBase::VTableLayoutMap.find(STR("CheckValidObject")); it == FObjectPropertyBase::VTableLayoutMap.end())
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("CheckValidObject"), 0x220);
}
...
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("AllowObjectTypeReinterpretationTo"), 0x228);
}

if (auto it = FObjectPropertyBase::VTableLayoutMap.find(STR("AllowCrossLevel")); it == FObjectPropertyBase::VTableLayoutMap.end())
{
    FObjectPropertyBase::VTableLayoutMap.emplace(STR("AllowCrossLevel"), 0x230);
}
