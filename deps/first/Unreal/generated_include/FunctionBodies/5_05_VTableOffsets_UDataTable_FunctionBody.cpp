...
{
    UDataTable::VTableLayoutMap.emplace(STR("AddRow__FName__Ptr_C_uint8__Ptr_C_UScriptStruct"), 0x308);
}

if (auto it = UDataTable::VTableLayoutMap.find(STR("AddRow__FName__Ref_C_FTableRowBase")); it == UDataTable::VTableLayoutMap.end())
{
    UDataTable::VTableLayoutMap.emplace(STR("AddRow__FName__Ref_C_FTableRowBase"), 0x310);
}
