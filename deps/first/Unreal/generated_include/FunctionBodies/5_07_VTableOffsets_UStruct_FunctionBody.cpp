...
if (auto it = UStruct::VTableLayoutMap.find(STR("SerializeTaggedProperties_C__FStructuredArchiveSlot__Ptr_uint8__Ptr_C_UStruct__Ptr_C_uint8__Ptr_C_UObject")); it == UStruct::VTableLayoutMap.end())
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_C__FStructuredArchiveSlot__Ptr_uint8__Ptr_C_UStruct__Ptr_C_uint8__Ptr_C_UObject"), 0x2E0);
}

if (auto it = UStruct::VTableLayoutMap.find(STR("SerializeTaggedProperties_C__Ref_FArchive__Ptr_uint8__Ptr_C_UStruct__Ptr_C_uint8__Ptr_C_UObject")); it == UStruct::VTableLayoutMap.end())
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_C__Ref_FArchive__Ptr_uint8__Ptr_C_UStruct__Ptr_C_uint8__Ptr_C_UObject"), 0x2E8);
}
