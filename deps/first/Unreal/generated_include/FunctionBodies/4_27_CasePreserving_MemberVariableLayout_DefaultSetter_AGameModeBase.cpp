...
{
    AGameModeBase::MemberOffsets.emplace(STR("bStartPlayersAsSpectators"), 0x2B8);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("bPauseable"), 0x2B8);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x2D0);
}
