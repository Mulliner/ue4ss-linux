...
{
    AGameModeBase::MemberOffsets.emplace(STR("bPauseable"), 0x300);
    AGameModeBase::BitfieldInfos.emplace(STR("bPauseable"), BitfieldInfo{2, 1, 16});
}

if (auto it = AGameModeBase::MemberOffsets.find(STR("UEP_TotalSize")); it == AGameModeBase::MemberOffsets.end())
{
    AGameModeBase::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x318);
}
