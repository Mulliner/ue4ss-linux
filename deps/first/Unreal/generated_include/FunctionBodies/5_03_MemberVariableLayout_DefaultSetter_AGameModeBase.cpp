...
{
    AGameModeBase::MemberOffsets.emplace(STR("bStartPlayersAsSpectators"), 0x320);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("bPauseable"), 0x320);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x338);
}
