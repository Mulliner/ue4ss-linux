...
if (auto it = ULocalPlayer::MemberOffsets.find(STR("bEmulateSplitscreen")); it == ULocalPlayer::MemberOffsets.end())
{
    ULocalPlayer::MemberOffsets.emplace(STR("bEmulateSplitscreen"), 0xCC);
}
...
if (auto it = ULocalPlayer::MemberOffsets.find(STR("ConnectionIdentifier")); it == ULocalPlayer::MemberOffsets.end())
{
    ULocalPlayer::MemberOffsets.emplace(STR("ConnectionIdentifier"), 0x100);
}

if (auto it = ULocalPlayer::MemberOffsets.find(STR("PlatformUserId")); it == ULocalPlayer::MemberOffsets.end())
{
    ULocalPlayer::MemberOffsets.emplace(STR("PlatformUserId"), 0x104);
}

if (auto it = ULocalPlayer::MemberOffsets.find(STR("SlateOperations")); it == ULocalPlayer::MemberOffsets.end())
{
    ULocalPlayer::MemberOffsets.emplace(STR("SlateOperations"), 0x200);
}

if (auto it = ULocalPlayer::MemberOffsets.find(STR("UEP_TotalSize")); it == ULocalPlayer::MemberOffsets.end())
{
    ULocalPlayer::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x2B8);
}
