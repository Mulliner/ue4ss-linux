...
{
    UWorld::MemberOffsets.emplace(STR("bAggressiveLOD"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsDefaultLevel"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bRequestedBlockOnAsyncLoading"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bActorsInitialized"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bBegunPlay"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bMatchStarted"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bPlayersOnly"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bPlayersOnlyPending"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bStartup"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bIsTearingDown"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bKismetScriptError"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bDebugPauseExecution"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bAllowAudioPlayback"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bDebugFrameStepExecution"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("bAreConstraintsDirty"), 0x934);
...
{
    UWorld::MemberOffsets.emplace(STR("AsyncPreRegisterLevelStreamingTasks"), 0x938);
}

if (auto it = UWorld::MemberOffsets.find(STR("UEP_TotalSize")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x950);
}
