...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Serialize__FStructuredArchiveSlot__Ptr_void"), 0x28);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Serialize__Ref_FArchive__Ptr_void"), 0x30);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("FindInnerPropertyInstance"), 0x80);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("InitializeIntrusiveUnsetOptionalValue"), 0xA8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("IsIntrusiveOptionalValueSet"), 0xB0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("ClearIntrusiveOptionalValue"), 0xB8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("IsIntrusiveOptionalSafeForGC"), 0xC0);
}

if (auto it = UScriptStruct::ICppStructOps::VTableLayoutMap.find(STR("Visit")); it == UScriptStruct::ICppStructOps::VTableLayoutMap.end())
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Visit"), 0xC8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("ResolveVisitedPathInfo"), 0xD0);
}
