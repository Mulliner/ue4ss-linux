...
if (auto it = AActor::MemberOffsets.find(STR("bNetStartup")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bNetStartup"), BitfieldInfo{1, 1, 8});
}
...
{
    AActor::MemberOffsets.emplace(STR("bForceNetAddressable"), 0x58);
...
if (auto it = AActor::MemberOffsets.find(STR("bNetLoadOnClient")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bNetLoadOnClient"), BitfieldInfo{1, 1, 8});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bBlockInput")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bBlockInput"), BitfieldInfo{1, 1, 8});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bReplicates")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bReplicates"), BitfieldInfo{1, 1, 8});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bHasDeferredComponentRegistration")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bHasDeferredComponentRegistration"), BitfieldInfo{1, 1, 8});
}
...
{
    AActor::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x220);
}
