...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeBin_C__FStructuredArchive_FSlot__Ptr_void"), 0x260);
}
...
{
    UStruct::VTableLayoutMap.emplace(STR("SerializeTaggedProperties_C__FStructuredArchive_FSlot__Ptr_uint8__Ptr_UStruct__Ptr_uint8__Ptr_C_UObject"), 0x268);
}
