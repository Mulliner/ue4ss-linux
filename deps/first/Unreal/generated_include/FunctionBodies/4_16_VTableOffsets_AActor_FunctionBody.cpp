...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority__Ref_C_FVector__Ref_C_FVector__Ptr_APlayerController__Ptr_UActorChannel__float__bool"), 0x368);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetPriority__Ref_C_FVector__Ref_C_FVector__Ptr_AActor__Ptr_AActor__Ptr_UActorChannel__float__bool"), 0x370);
}

if (auto it = AActor::VTableLayoutMap.find(STR("GetReplayPriority")); it == AActor::VTableLayoutMap.end())
{
    AActor::VTableLayoutMap.emplace(STR("GetReplayPriority"), 0x378);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("GetNetDormancy__Ref_C_FVector__Ref_C_FVector__Ptr_APlayerController__Ptr_AActor__Ptr_UActorChannel__float__bool"), 0x380);
}
...
{
    AActor::VTableLayoutMap.emplace(STR("IsNetRelevantFor_C__Ptr_C_APlayerController__Ptr_C_AActor__Ref_C_FVector"), 0x418);
}
