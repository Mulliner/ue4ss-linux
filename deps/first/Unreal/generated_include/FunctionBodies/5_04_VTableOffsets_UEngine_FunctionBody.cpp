...
{
    UEngine::VTableLayoutMap.emplace(STR("GetTimeBetweenGarbageCollectionPasses_C__bool"), 0x390);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("ShouldForceGarbageCollection"), 0x3B8);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UPendingNetGame__Ref_FString__bool"), 0x480);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UNetConnection__Ref_FString__bool"), 0x488);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ptr_UNetDriver"), 0x4F8);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("CancelPending__Ref_FWorldContext")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ref_FWorldContext"), 0x500);
}
