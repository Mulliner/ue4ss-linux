...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UPendingNetGame__Ref_FString__bool"), 0x390);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("HandleNetworkFailure_NotifyGameInstance"), 0x468);
}

if (auto it = UEngine::VTableLayoutMap.find(STR("HandleTravelFailure_NotifyGameInstance")); it == UEngine::VTableLayoutMap.end())
{
    UEngine::VTableLayoutMap.emplace(STR("HandleTravelFailure_NotifyGameInstance"), 0x470);
}
