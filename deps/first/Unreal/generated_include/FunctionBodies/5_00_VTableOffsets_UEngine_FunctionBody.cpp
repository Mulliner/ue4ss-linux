...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UPendingNetGame__Ref_FString__bool"), 0x468);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("NetworkRemapPath__Ptr_UNetConnection__Ref_FString__bool"), 0x470);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("CancelPending__Ptr_UWorld__Ptr_UPendingNetGame"), 0x4F8);
}
...
{
    UEngine::VTableLayoutMap.emplace(STR("VerifyLoadMapWorldCleanup"), 0x508);
}
