...
{
    FArchive::VTableLayoutMap.emplace(STR("AttachBulkData__Ptr_UE_Serialization_FEditorBulkData"), 0x1C0);
}

if (auto it = FArchive::VTableLayoutMap.find(STR("AttachBulkData__Ptr_UObject__Ptr_FBulkData")); it == FArchive::VTableLayoutMap.end())
{
    FArchive::VTableLayoutMap.emplace(STR("AttachBulkData__Ptr_UObject__Ptr_FBulkData"), 0x1C8);
}
