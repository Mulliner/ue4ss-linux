...
{
    UClass::VTableLayoutMap.emplace(STR("SerializeDefaultObject__Ptr_UObject__Ref_FArchive"), 0x3B0);
}
...
{
    UClass::VTableLayoutMap.emplace(STR("SerializeDefaultObject__Ptr_UObject__FStructuredArchiveSlot"), 0x3B8);
}
...
if (auto it = UClass::VTableLayoutMap.find(STR("SupportsDynamicInstancedReference")); it == UClass::VTableLayoutMap.end())
{
    UClass::VTableLayoutMap.emplace(STR("SupportsDynamicInstancedReference"), 0x400);
}
