...
{
    AGameModeBase::MemberOffsets.emplace(STR("bStartPlayersAsSpectators"), 0x3B8);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("bPauseable"), 0x3B8);
...
{
    AGameModeBase::MemberOffsets.emplace(STR("Pausers"), 0x3C0);
}

if (auto it = AGameModeBase::MemberOffsets.find(STR("UEP_TotalSize")); it == AGameModeBase::MemberOffsets.end())
{
    AGameModeBase::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x3D0);
}
