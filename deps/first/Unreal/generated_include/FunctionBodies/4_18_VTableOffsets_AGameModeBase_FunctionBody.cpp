...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin__Ref_C_FString__Ref_C_FString__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_FString"), 0x6E0);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("PreLogin__Ref_C_FString__Ref_C_FString__Ref_C_FUniqueNetIdRepl__Ref_FString"), 0x6E8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login__Ptr_UPlayer__ENetRole__Ref_C_FString__Ref_C_FString__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_FString"), 0x6F0);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("Login__Ptr_UPlayer__ENetRole__Ref_C_FString__Ref_C_FString__Ref_C_FUniqueNetIdRepl__Ref_FString"), 0x6F8);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer__Ptr_APlayerController__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_C_FString__Ref_C_FString"), 0x768);
}
