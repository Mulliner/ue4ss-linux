...
if (auto it = UGameViewportClient::MemberOffsets.find(STR("CurrentStrataVisualizationMode")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("CurrentStrataVisualizationMode"), 0x148);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x3B0);
}
