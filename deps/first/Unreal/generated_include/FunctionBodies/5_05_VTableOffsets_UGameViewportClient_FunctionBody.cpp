...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddViewportWidgetContent"), 0x300);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("RemoveViewportWidgetContent"), 0x308);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddViewportWidgetForPlayer"), 0x310);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("RemoveViewportWidgetForPlayer"), 0x318);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("AddGameLayerWidget")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("AddGameLayerWidget"), 0x320);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("RemoveGameLayerWidget")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("RemoveGameLayerWidget"), 0x328);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("DetachViewportClient")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("DetachViewportClient"), 0x330);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("Tick")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("Tick"), 0x338);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("SetViewportFrame")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("SetViewportFrame"), 0x340);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("SetViewport")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("SetViewport"), 0x348);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("SetDropDetail")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("SetDropDetail"), 0x350);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("ConsoleCommand")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("ConsoleCommand"), 0x358);
}

if (auto it = UGameViewportClient::VTableLayoutMap.find(STR("GetMousePosition")); it == UGameViewportClient::VTableLayoutMap.end())
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("GetMousePosition"), 0x360);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("SetupInitialLocalPlayer"), 0x368);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("PeekTravelFailureMessages"), 0x3B8);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("PeekNetworkFailureMessages"), 0x3C0);
}
...
{
    UGameViewportClient::VTableLayoutMap.emplace(STR("VerifyPathRenderingComponents"), 0x3C8);
}
