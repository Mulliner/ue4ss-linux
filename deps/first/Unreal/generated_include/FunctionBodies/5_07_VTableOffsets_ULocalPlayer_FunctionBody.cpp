...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PreBeginHandshake"), 0x310);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("SendSplitJoin__Ref_TArray_FString_TSizedDefaultAllocator_32___Ptr_UNetDriver__UE_Net_EJoinFlags")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("SendSplitJoin__Ref_TArray_FString_TSizedDefaultAllocator_32___Ptr_UNetDriver__UE_Net_EJoinFlags"), 0x318);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("SendSplitJoin__Ref_TArray_FString_TSizedDefaultAllocator_32_")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("SendSplitJoin__Ref_TArray_FString_TSizedDefaultAllocator_32_"), 0x320);
}
