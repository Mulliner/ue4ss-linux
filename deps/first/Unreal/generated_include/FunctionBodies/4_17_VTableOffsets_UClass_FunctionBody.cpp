...
{
    UClass::VTableLayoutMap.emplace(STR("GetRequiredPreloadDependencies"), 0x310);
}

if (auto it = UClass::VTableLayoutMap.find(STR("HasInstrumentation")); it == UClass::VTableLayoutMap.end())
{
    UClass::VTableLayoutMap.emplace(STR("HasInstrumentation"), 0x318);
}

if (auto it = UClass::VTableLayoutMap.find(STR("CreateDefaultObject")); it == UClass::VTableLayoutMap.end())
{
    UClass::VTableLayoutMap.emplace(STR("CreateDefaultObject"), 0x320);
}
