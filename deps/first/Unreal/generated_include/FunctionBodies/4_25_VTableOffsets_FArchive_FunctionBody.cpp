...
if (auto it = FArchive::VTableLayoutMap.find(STR("SetArchiveState")); it == FArchive::VTableLayoutMap.end())
{
    FArchive::VTableLayoutMap.emplace(STR("SetArchiveState"), 0x200);
}
