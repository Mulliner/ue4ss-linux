...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerController__ENetRole__Ref_C_FVector__Ref_C_FRotator"), 0x728);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("SpawnPlayerControllerCommon"), 0x7C8);
}
