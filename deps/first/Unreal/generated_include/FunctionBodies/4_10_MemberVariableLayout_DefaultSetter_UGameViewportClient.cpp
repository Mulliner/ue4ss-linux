...
{
    UGameViewportClient::MemberOffsets.emplace(STR("CursorWidgets"), 0x100);
}
...
{
    UGameViewportClient::MemberOffsets.emplace(STR("StatUnitData"), 0x218);
}

if (auto it = UGameViewportClient::MemberOffsets.find(STR("StatHitchesData")); it == UGameViewportClient::MemberOffsets.end())
{
    UGameViewportClient::MemberOffsets.emplace(STR("StatHitchesData"), 0x220);
}
