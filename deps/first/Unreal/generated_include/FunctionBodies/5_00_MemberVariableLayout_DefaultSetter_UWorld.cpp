...
{
    UWorld::MemberOffsets.emplace(STR("bAllowDeferredPhysicsStateCreation"), 0xF8);
}
...
if (auto it = UWorld::MemberOffsets.find(STR("bIsBuilt")); it == UWorld::MemberOffsets.end())
{
    ...
    UWorld::BitfieldInfos.emplace(STR("bIsBuilt"), BitfieldInfo{3, 1, 4});
}
...
if (auto it = UWorld::MemberOffsets.find(STR("bDropDetail")); it == UWorld::MemberOffsets.end())
{
    ...
    UWorld::BitfieldInfos.emplace(STR("bDropDetail"), BitfieldInfo{3, 1, 4});
}
...
if (auto it = UWorld::MemberOffsets.find(STR("bPlayersOnlyPending")); it == UWorld::MemberOffsets.end())
{
    ...
    UWorld::BitfieldInfos.emplace(STR("bPlayersOnlyPending"), BitfieldInfo{3, 1, 4});
}
...
if (auto it = UWorld::MemberOffsets.find(STR("bRequiresHitProxies")); it == UWorld::MemberOffsets.end())
{
    ...
    UWorld::BitfieldInfos.emplace(STR("bRequiresHitProxies"), BitfieldInfo{3, 1, 4});
}
...
if (auto it = UWorld::MemberOffsets.find(STR("bInitializedAndNeedsCleanup")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("bInitializedAndNeedsCleanup"), 0x117);
    UWorld::BitfieldInfos.emplace(STR("bInitializedAndNeedsCleanup"), BitfieldInfo{1, 1, 1});
}

if (auto it = UWorld::MemberOffsets.find(STR("IsInBlockTillLevelStreamingCompleted")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("IsInBlockTillLevelStreamingCompleted"), 0x118);
}

if (auto it = UWorld::MemberOffsets.find(STR("BlockTillLevelStreamingCompletedEpoch")); it == UWorld::MemberOffsets.end())
{
    UWorld::MemberOffsets.emplace(STR("BlockTillLevelStreamingCompletedEpoch"), 0x11C);
}
