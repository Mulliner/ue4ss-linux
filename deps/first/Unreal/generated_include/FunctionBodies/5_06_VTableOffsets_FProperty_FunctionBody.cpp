...
{
    FProperty::VTableLayoutMap.emplace(STR("HasSetter"), 0x70);
}

if (auto it = FProperty::VTableLayoutMap.find(STR("HasGetter")); it == FProperty::VTableLayoutMap.end())
{
    FProperty::VTableLayoutMap.emplace(STR("HasGetter"), 0x78);
}

if (auto it = FProperty::VTableLayoutMap.find(STR("HasSetterOrGetter")); it == FProperty::VTableLayoutMap.end())
{
    FProperty::VTableLayoutMap.emplace(STR("HasSetterOrGetter"), 0x80);
}

if (auto it = FProperty::VTableLayoutMap.find(STR("CallSetter")); it == FProperty::VTableLayoutMap.end())
{
    FProperty::VTableLayoutMap.emplace(STR("CallSetter"), 0x88);
}

if (auto it = FProperty::VTableLayoutMap.find(STR("CallGetter")); it == FProperty::VTableLayoutMap.end())
{
    FProperty::VTableLayoutMap.emplace(STR("CallGetter"), 0x90);
}

if (auto it = FProperty::VTableLayoutMap.find(STR("Visit_C__Ref_FPropertyVisitorContext__C_TFunctionRef_enum_EPropertyVisitorControlFlow_cdecl_FPropertyVisitorContext_const_&_")); it == FProperty::VTableLayoutMap.end())
{
    FProperty::VTableLayoutMap.emplace(STR("Visit_C__Ref_FPropertyVisitorContext__C_TFunctionRef_enum_EPropertyVisitorControlFlow_cdecl_FPropertyVisitorContext_const_&_"), 0x98);
}

if (auto it = FProperty::VTableLayoutMap.find(STR("ResolveVisitedPathInfo")); it == FProperty::VTableLayoutMap.end())
{
    FProperty::VTableLayoutMap.emplace(STR("ResolveVisitedPathInfo"), 0xA0);
}
