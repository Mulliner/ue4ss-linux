...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasStructuredSerializer"), 0x38);
}

if (auto it = UScriptStruct::ICppStructOps::VTableLayoutMap.find(STR("Serialize__FStructuredArchive_FSlot__Ptr_void")); it == UScriptStruct::ICppStructOps::VTableLayoutMap.end())
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Serialize__FStructuredArchive_FSlot__Ptr_void"), 0x40);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Serialize__Ref_FArchive__Ptr_void"), 0x48);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasPostSerialize"), 0x50);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("PostSerialize"), 0x58);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasNetSerializer"), 0x60);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasNetSharedSerialization"), 0x68);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("NetSerialize"), 0x70);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasNetDeltaSerializer"), 0x78);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("NetDeltaSerialize"), 0x80);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasPostScriptConstruct"), 0x88);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("PostScriptConstruct"), 0x90);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("IsPlainOldData"), 0x98);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasCopy"), 0xA0);
}

if (auto it = UScriptStruct::ICppStructOps::VTableLayoutMap.find(STR("Copy")); it == UScriptStruct::ICppStructOps::VTableLayoutMap.end())
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Copy"), 0xA8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasIdentical"), 0xB0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("Identical"), 0xB8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasExportTextItem"), 0xC0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("ExportTextItem"), 0xC8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasImportTextItem"), 0xD0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("ImportTextItem"), 0xD8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasAddStructReferencedObjects"), 0xE0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("AddStructReferencedObjects"), 0xE8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasSerializeFromMismatchedTag"), 0xF0);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasStructuredSerializeFromMismatchedTag"), 0xF8);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("SerializeFromMismatchedTag"), 0x100);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("StructuredSerializeFromMismatchedTag"), 0x108);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("HasGetTypeHash"), 0x110);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("GetTypeHash"), 0x118);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("GetComputedPropertyFlags"), 0x120);
}
...
{
    UScriptStruct::ICppStructOps::VTableLayoutMap.emplace(STR("IsAbstract"), 0x128);
}
