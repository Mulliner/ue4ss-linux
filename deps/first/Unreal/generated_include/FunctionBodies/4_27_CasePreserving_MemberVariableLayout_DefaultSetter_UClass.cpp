...
{
    UClass::MemberOffsets.emplace(STR("FuncMap"), 0x140);
}

if (auto it = UClass::MemberOffsets.find(STR("SuperFuncMap")); it == UClass::MemberOffsets.end())
{
    UClass::MemberOffsets.emplace(STR("SuperFuncMap"), 0x190);
}
