...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer__Ptr_APlayerController__Ref_C_TSharedPtr_FUniqueNetId_const_0___Ref_C_FString__Ref_C_FString"), 0x770);
}
...
{
    AGameModeBase::VTableLayoutMap.emplace(STR("InitNewPlayer__Ptr_APlayerController__Ref_C_FUniqueNetIdRepl__Ref_C_FString__Ref_C_FString"), 0x778);
}
