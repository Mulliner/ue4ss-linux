...
{
    UObject::VTableLayoutMap.emplace(STR("Modify"), 0x68);
}

if (auto it = UObject::VTableLayoutMap.find(STR("IsReadyForAsyncPostLoad")); it == UObject::VTableLayoutMap.end())
{
    UObject::VTableLayoutMap.emplace(STR("IsReadyForAsyncPostLoad"), 0x70);
}
