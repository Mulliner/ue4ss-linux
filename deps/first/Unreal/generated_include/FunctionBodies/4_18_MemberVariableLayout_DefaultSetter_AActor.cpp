...
if (auto it = AActor::MemberOffsets.find(STR("bHasDeferredComponentRegistration")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bHasDeferredComponentRegistration"), BitfieldInfo{0, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bActorEnableCollision")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bActorEnableCollision"), BitfieldInfo{1, 1, 1});
}
...
if (auto it = AActor::MemberOffsets.find(STR("bNetCheckedInitialPhysicsState")); it == AActor::MemberOffsets.end())
{
    ...
    AActor::BitfieldInfos.emplace(STR("bNetCheckedInitialPhysicsState"), BitfieldInfo{2, 1, 1});
}
...
{
    AActor::MemberOffsets.emplace(STR("RemoteRole"), 0x87);
}
...
{
    AActor::MemberOffsets.emplace(STR("NetDriverName"), 0x90);
}
...
{
    AActor::MemberOffsets.emplace(STR("InitialLifeSpan"), 0xCC);
}
...
{
    AActor::MemberOffsets.emplace(STR("bGenerateOverlapEventsDuringLevelStreaming"), 0x13C);
...
{
    AActor::MemberOffsets.emplace(STR("bCanBeInCluster"), 0x13C);
    AActor::BitfieldInfos.emplace(STR("bCanBeInCluster"), BitfieldInfo{7, 1, 1});
}

if (auto it = AActor::MemberOffsets.find(STR("bAllowReceiveTickEventOnDedicatedServer")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("bAllowReceiveTickEventOnDedicatedServer"), 0x13D);
...
{
    AActor::MemberOffsets.emplace(STR("bActorInitialized"), 0x13D);
...
{
    AActor::MemberOffsets.emplace(STR("ActorHasBegunPlay"), 0x13D);
...
{
    AActor::MemberOffsets.emplace(STR("bActorSeamlessTraveled"), 0x13D);
...
{
    AActor::MemberOffsets.emplace(STR("bIgnoresOriginShifting"), 0x13D);
...
{
    AActor::MemberOffsets.emplace(STR("bEnableAutoLODGeneration"), 0x13D);
...
{
    AActor::MemberOffsets.emplace(STR("SpawnCollisionHandlingMethod"), 0x13E);
}

if (auto it = AActor::MemberOffsets.find(STR("CreationTime")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("CreationTime"), 0x140);
}
...
{
    AActor::MemberOffsets.emplace(STR("TimerHandle_LifeSpanExpired"), 0x178);
}

if (auto it = AActor::MemberOffsets.find(STR("Layers")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("Layers"), 0x180);
}
...
{
    AActor::MemberOffsets.emplace(STR("DetachFence"), 0x360);
}

if (auto it = AActor::MemberOffsets.find(STR("UEP_TotalSize")); it == AActor::MemberOffsets.end())
{
    AActor::MemberOffsets.emplace(STR("UEP_TotalSize"), 0x368);
}
