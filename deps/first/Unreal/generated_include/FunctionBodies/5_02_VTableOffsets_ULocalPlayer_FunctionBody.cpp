...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("GetViewPoint"), 0x2C0);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("GetSlateUser_C")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("GetSlateUser_C"), 0x2C8);
}
...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("CalcSceneViewInitOptions"), 0x2D8);
}

if (auto it = ULocalPlayer::VTableLayoutMap.find(STR("CalcSceneView")); it == ULocalPlayer::VTableLayoutMap.end())
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("CalcSceneView"), 0x2E0);
}
...
{
    ULocalPlayer::VTableLayoutMap.emplace(STR("PlayerAdded__Ptr_UGameViewportClient__FPlatformUserId"), 0x2E8);
}
