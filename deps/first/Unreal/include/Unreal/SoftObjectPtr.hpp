...
namespace RC::Unreal
{
    ...
    */
    struct FSoftObjectPtr : public TPersistentObjectPtr<FSoftObjectPath>
    {
        ...
        FORCEINLINE explicit FSoftObjectPtr(const FSoftObjectPath& ObjectPath)
            : TPersistentObjectPtr<FSoftObjectPath>(ObjectPath)
        {
        }

        /** Construct from an object already in memory */
        FORCEINLINE explicit FSoftObjectPtr(const UObject* Object)
        {
            (*this)=Object;
        }
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            UClass* Class = reinterpret_cast<UClass*>(SoftObjectPtr.Get());
        ...
        */
        ...
        {
            UObject* Asset = SoftObjectPtr.LoadSynchronous();
            UClass* Class = static_cast<UClass*>(Asset);
            if (!Class || !Class->IsChildOf(TClass::StaticClass()))
            {
                return nullptr;
            }
