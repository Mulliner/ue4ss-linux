...
#include "Unreal/Core/Containers/ContainerHelpers.hpp"
#include "Unreal/Core/HAL/PlatformMath.hpp"
...
#include "Unreal/Core/Templates/IsPolymorphic.hpp"
...
static_assert(UE_CONTAINER_SLACK_GROWTH_FACTOR_DENOMINATOR > UE_CONTAINER_SLACK_GROWTH_FACTOR_NUMERATOR, "UE_CONTAINER_SLACK_GROWTH_FACTOR_DENOMINATOR must be greater than UE_CONTAINER_SLACK_GROWTH_FACTOR_NUMERATOR");
  ...
  public:
      ...
      {
          template <typename T, typename A> friend class TArray;
      public:
  ...
  // Explicit specialization before instantiation to satisfy GCC
  template <> struct TAllocatorTraits<FDefaultBitArrayAllocator> : TAllocatorTraits<TInlineAllocator<4>> {};
